...
export default function CTASection() {
  ...
  return (
      <section id="work" className="py-24 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">
                {t("cta.title1")} <span className="gradient-text">{t("cta.title2")}</span> {t("cta.title3")}
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold">{t("cta.joinTeamTitle")}</h3>
                  </div>
                  <p className="text-white/70 mb-4">{t("cta.joinTeamDesc")}</p>
                  <div className="flex items-center space-x-2 text-sm text-white/50">
                    ...
                    <span>🇩🇪</span>
                    <span>🇮🇹</span>
                    <span className="text-xs">+10 {t("cta.more")}</span>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold">{t("cta.startProjectTitle")}</h3>
                  </div>
                  <p className="text-white/70 mb-4">{t("cta.startProjectDesc")}</p>
              ...
              <FloatingAnimation>
                <div className="w-96 h-96 glassmorphism rounded-2xl p-8 relative">
                  ...
                  <div className="relative z-10 h-full flex flex-col items-center justify-center">
                    ...
                    <h3 className="text-2xl font-bold mb-2 text-center">{t("cta.boxTitle")}</h3>
                    <p className="text-white/70 text-center">{t("cta.boxDesc")}</p>
        ...
        <FreelancerModal isOpen={showFreelancerModal} onClose={() => setShowFreelancerModal(false)} />
