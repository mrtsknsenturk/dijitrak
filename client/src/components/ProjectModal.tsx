            ...
            {!isSubmitted ? (
              ...
              <div className="text-center py-8">
                ...
                <Button
                  ...
                  className="btn-primary bg-gradient-to-r from-primary to-secondary py-3 px-8 rounded-lg text-white font-medium transition-all duration-300 hover:shadow-lg"
                >
                  Close
                </Button>
              </div>
