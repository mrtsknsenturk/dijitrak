...
export const translations: TranslationsData = {
  en: {
    ...
    "admin.analytics.service_distribution": "Distribution of requested services",
    "admin.analytics.conversion_rates": "Conversion Rates",
    "admin.analytics.conversion_description": "Conversion rates from project requests to completed projects",
    "admin.analytics.requests.by.status": "Requests by Status",
    "admin.analytics.monthly.requests": "Monthly Requests",
    "admin.analytics.last_6_months": "Requests over the last 6 months",
  ...
  tr: {
    ...
    "admin.analytics.service_distribution": "Talep edilen hizmetlerin dağılımı",
    "admin.analytics.conversion_rates": "Dönüşüm Oranları",
    "admin.analytics.conversion_description": "Proje taleplerinden tamamlanan projelere dönüşüm oranları",
    "admin.analytics.requests.by.status": "Durum Bazında Talepler",
    "admin.analytics.monthly.requests": "Aylık Talepler",
    "admin.analytics.last_6_months": "Son 6 aydaki talepler",
